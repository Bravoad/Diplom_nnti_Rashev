...
?>
<div class="content">
    <form  method="post"  role="form" class="form-inline"  action="http://Rizar:8080/index.php/UDog/update2">
        <div class="form-group mb-lg-0 col-lg-offset-0">
            <table>
                <tr>
                    ...
                    <td>
                        <label for="">&nbsp <b>Дата выполнения</b></label>
                        <br>
                ...
                <tr>
                    <td>
                        <button type="submit" class="btn-primary">Подписать акт о выполнении договора</button>
                    </td>
                </TR>
            </table>
        </div>
